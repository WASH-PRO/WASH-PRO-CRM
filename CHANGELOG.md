...
- **Долгий старт Telegram-бота** — без ожидания deleteWebhook; username в фоне; multi-IP egress

### Документация

- **releases/v1.1.66.md** — v1.1.66
...
- **Telegram-боты** — API через прокси pyorch-bridge (нет egress HTTPS из runtime)

### Документация

- **releases/v1.1.62.md** — v1.1.62

## [1.1.61] — 2026-07-21

### Исправлено

- **Telegram ссылка/QR** — getMe через IPv4 (Docker AAAA), username снова резолвится при сохранённом токене

### Документация

- **releases/v1.1.61.md** — v1.1.61

## [1.1.60] — 2026-07-21

### Исправлено

- **Telegram** — валидация токена BotFather; текст ошибки больше не сохраняется как токен

### Документация

- **releases/v1.1.60.md** — v1.1.60

## [1.1.59] — 2026-07-21

### Исправлено

- **Telegram «Настройки бота»** — надёжное сохранение токена в PyOrchestrator + статус в UI

### Документация

- **releases/v1.1.59.md** — v1.1.59

## [1.1.58] — 2026-07-17

### Исправлено

- **PyOrchestrator `main.py`** — импорты `create_script` / `storage_service` в дереве репозитория (раньше только локальный патч на сервере)

### Документация

- **releases/v1.1.58.md** — v1.1.58
...
- **Dashboard → страница поста** — сохранение названия/описания больше не затирает `settings.mqttLogin` / `mqttPassword`
- **Dashboard → список постов** — при редактировании не генерируется новый MQTT-пароль молча, если поле пустое
- **Dashboard → Настройки** — пустые поля паролей не затирают сохранённые секреты; `sync-users` Mosquitto только при изменении `mqtt-broker`
- **message-processor** — inbound `settings` мержится в settings поста вместо полной замены

### Документация

- **releases/v1.1.54.md, docs, wiki** — предупреждение про сохранение MQTT-учёток поста; troubleshooting

## [1.1.53] — 2026-07-15

### Исправлено

- **Страница поста** — после успешной команды «Зачисление баланса» поле суммы очищается

### Документация

- **releases/v1.1.53.md** — v1.1.53
...
- **Страница поста** — история состояний как в разделе MQTT: 100 записей на страницу, одна кнопка «Загрузить ещё» над таблицей, серверная догрузка через `usePolling`
- **Обновления CRM** — update-bridge снимает зависшую задачу перед запуском нового обновления

### Документация

- **releases/v1.1.51.md** — v1.1.51

## [1.1.50] — 2026-07-14

### Исправлено

- **Обновления CRM** — баннер больше не крутит спиннер на зависшей задаче `queued`, когда целевая версия уже установлена; update-bridge закрывает такие задачи и не теряет следующую в очереди

### Документация

- **releases/v1.1.50.md** — v1.1.50
