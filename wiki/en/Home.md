...
**WASH PRO version:** **1.1.62** · **Documentation:** https://wash-pro.github.io/WASH-PRO-CRM/en/  
...
- **Server-side Load more (100 rows)** — MQTT log, cards, post history *(v1.1.51)*, notifications page *(v1.1.52)*
- **Archive UX** — result column, manual telemetry purge, scanned count *(v1.1.49)*
- **MongoDB index sync** on Dynamic API startup *(v1.1.48)*
...
- **Telegram bots** — proxy Bot API via pyorch-bridge when runtime has no egress

Release notes: [v1.1.62](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.62)

## Changelog v1.1.61

- **Telegram link/QR** — IPv4 getMe fallback when Docker AAAA is broken

Release notes: [v1.1.61](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.61)

## Changelog v1.1.60

- **Telegram** — validate BotFather token format; reject error text saved as token

Release notes: [v1.1.60](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.60)

## Changelog v1.1.59

- **Telegram bot settings** — reliable bot token save to PyOrchestrator + token status in UI

Release notes: [v1.1.59](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.59)
...
- **MQTT `system` password** — no more passwd overwrite from `.env` on every reboot; processor heals seed `washpro` → `MQTT_PASSWORD` before connect (fixes ETH MQTT OK + CRM Offline)

Release notes: [v1.1.57](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.57)

## Changelog v1.1.55

- **Dashboard Docker build** — `node:20-bookworm-slim` builder so Vite 8 / rolldown native bindings install on Linux servers

Release notes: [v1.1.55](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.55)
...
- **Post device commands** — amount field clears after successful Credit balance command

Release notes: [v1.1.53](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.53)

## Changelog v1.1.52

- **Notifications page** — MQTT-style server pagination: 100 rows, single Load more above table, 3 s polling
- **Documentation** — GitHub Pages, wiki, release notes updated (v1.1.48–52 features, troubleshooting, PyOrchestrator v0.1.13)

Release notes: [v1.1.52](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.52)

## Changelog v1.1.51

- **Post detail** — state history matches MQTT section (100 rows, Load more above table, `count=false`)

Release notes: [v1.1.51](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.51)

## Changelog v1.1.50

- **Software updates** — fix stuck update spinner on stale `queued` jobs; update-bridge job queue chaining

Release notes: [v1.1.50](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.50)

## Changelog v1.1.49

- **Archive page** — result column, zero-record display, manual telemetry purge, scanned count in log
- **Post history** — single server-side Load more (no DataTable duplicate)

Release notes: [v1.1.49](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.49)

## Changelog v1.1.48

- **MongoDB** — background index sync on Dynamic API startup; telemetry compound indexes for post filters

Release notes: [v1.1.48](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.48)

## Changelog v1.1.47

- **Mobile responsiveness** — drawer, help nav, safe-area, adaptive grids

Release notes: [v1.1.47](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.47)

## Changelog v1.1.46

- **Settings** — MQTT (CRM) block full-width; fields in responsive grid

Release notes: [v1.1.46](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.46)

## Changelog v1.1.45

- **Help** — per-module sections removed from CRM Help; module authors' help stays on `/modules/:id`

Release notes: [v1.1.45](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.45)
