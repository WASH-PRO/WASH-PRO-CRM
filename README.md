...
- **Built-in help** — fullscreen in-app help; **Help** item at the bottom of the sidebar (v1.1.22, v1.1.29)
...
- **i18n feature catalogs** — split translations for modules, updates, notifications (v1.1.37)
