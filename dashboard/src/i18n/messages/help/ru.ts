...
export const helpRu = {
  ...
  sections: {
    navigation: {
      ...
      summary:
        'Внизу sidebar: **Справка** (над «Ресурсы» / «Документация»), затем мастер настроек. В шапке — кнопка **Справка** слева.',
      howItWorks:
      ...
      regions: {
        kpi: 'Sidebar: Справка внизу над документацией; шапка: Справка слева',
