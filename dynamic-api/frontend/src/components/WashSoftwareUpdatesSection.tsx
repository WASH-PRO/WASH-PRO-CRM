...
/** Software Updates block for WASH-PRO-CRM (vendored Dynamic API, in-app updater disabled). */
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-lg border border-sky-200 bg-sky-50 p-4 dark:border-sky-800 dark:bg-sky-950/40">
        <p className="text-sm font-semibold text-sky-900 dark:text-sky-100">WASH-PRO-CRM — встроенная платформа</p>
      ...
      <div>
        ...
        <pre className="code-block whitespace-pre-wrap text-xs">{`cd WASH-PRO-CRM
