...
| Тема | Содержание |
|------|------------|
| **Меню CRM** | **Автоматизация →** Telegram, Публикации |
| **Информационный v2.2** | Фото + подпись одним сообщением; занятость: свободен только `program_9` |
| **Публикации** | «По расписанию» → «Опубликовано» после наступления времени |
...
1. **Dashboard → Автоматизация → Публикации** — создайте новость, статус **Опубликовано** или **По расписанию**
