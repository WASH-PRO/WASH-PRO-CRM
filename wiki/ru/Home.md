...
**WASH PRO version:** **1.1.62** · **Documentation:** https://wash-pro.github.io/WASH-PRO-CRM/ru/  
...
- **Telegram-боты** — прокси Bot API через pyorch-bridge при отсутствии egress у runtime

Заметки релиза: [v1.1.62](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.62)

## Changelog v1.1.61

- **Telegram ссылка/QR** — getMe через IPv4 при проблемах Docker AAAA

Заметки релиза: [v1.1.61](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.61)

## Changelog v1.1.60

- **Telegram** — валидация токена BotFather; текст ошибки больше не сохраняется как токен

Заметки релиза: [v1.1.60](https://github.com/WASH-PRO/WASH-PRO-CRM/releases/tag/v1.1.60)
