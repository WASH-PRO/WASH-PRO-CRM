...
export const helpRu = {
  ...
  sections: {
    navigation: {
      ...
      summary:
        'Боковое меню по группам, хлебные крошки над страницей и встроенная справка: кнопка «Справка» в шапке (бирюзовая) и пункт внизу бокового меню.',
      howItWorks:
      ...
      regions: {
        kpi: 'Шапка: Live, уведомления, Справка, язык',
