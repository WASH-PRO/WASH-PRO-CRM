...
| Группа | Разделы |
|--------|---------|
| **Главное** | Обзор, **Информация** (новости/акции для Telegram), SCADA |
...
| Telegram | `/telegram` | Боты PyOrchestrator: **Управление** / **Сервисный** / **Информационный**; QR-ссылка; массовые действия; шаблоны v3.1 / v1.8 *(Admin, PyOrch)* |
| **Информация** | `/info-messages` | Новости и акции для информационного бота *(Admin)* |
