...
Полная документация: [docs/mcp.md](../docs/mcp.md) · [GitHub Pages — MCP](https://wash-pro.github.io/WASH-PRO-CRM/mcp/)
...
См. [Troubleshooting](https://wash-pro.github.io/WASH-PRO-CRM/troubleshooting/), [Dashboard](Dashboard).
