...
echo "==> Перезапуск PyOrchestrator (Redis, backend, runtime, scheduler, bridge)..."
$COMPOSE up -d pyorch-redis pyorch-postgres pyorch-minio pyorch-backend pyorch-runtime pyorch-scheduler pyorch-bridge
