...
WASH_TELEGRAM_BOT_MAIN = '''"""Deprecated — create bots via WASH PRO CRM dashboard (Telegram page)."""
import sys

print("Шаблон устарел. Создайте и управляйте ботом в CRM: Настройки → Telegram.")
sys.exit(0)
'''
...
DEMO_TEMPLATES.append(
    {
        ...
        "description": "Deprecated — use CRM Telegram page (pyorch-bridge) to create bots",
        "category": "integrations",
