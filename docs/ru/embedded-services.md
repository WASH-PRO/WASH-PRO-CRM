...
**Информационный бот (v1.9):** контент из **Dashboard → Автоматизация → Информация**; рассылка подписчикам в **личных чатах**; изображения одним сообщением (фото + подпись); корректная занятость постов.
